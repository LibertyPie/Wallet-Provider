        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!this.isSupported()) {
                            return [2 /*return*/, Status.error("wallet_not_found")
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, Status.successPromise("", {
                                account: account,
                                provider: this._provider
                            })];
                    case 3:
                        e_1 = _b.sent();
                        return [2 /*return*/, Promise.resolve(Status.error(e_1.message).setCode(e_1.code))];
