...
var _PlatformWallets = /*#__PURE__*/function (_Web3Standard) {
  _inherits(_PlatformWallets, _Web3Standard);

  var _super = _createSuper(_PlatformWallets);

  function _PlatformWallets() {
    _classCallCheck(this, _PlatformWallets);

    return _super.apply(this, arguments);
  }

  _createClass(_PlatformWallets, [{
    ...
    value: function handlerEventLiteners() {
      ...
      if (typeof this._provider["on"] == 'function') {
        _get(_getPrototypeOf(_PlatformWallets.prototype), "handlerEventLiteners", this).call(this);
...
}(_Web3Standard2["default"]); //end fun 
