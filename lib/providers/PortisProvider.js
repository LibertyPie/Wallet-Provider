...
var PortisProvider = /*#__PURE__*/function (_PlatformWallets2) {
  _inherits(PortisProvider, _PlatformWallets2);

  var _super = _createSuper(PortisProvider);

  function PortisProvider() {
    _classCallCheck(this, PortisProvider);

    return _super.apply(this, arguments);
  }

  _createClass(PortisProvider, [{
    key: "_initialize",
    value: function () {
      var _initialize2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(providerInfo) {
        var providerPackage, packageOpts, pkgInstance;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                throw new _Exception["default"]("portis_package_required", "Portis package is required");

              case 3:
                packageOpts = providerInfo.options || {};
                pkgInstance = new providerPackage(packageOpts.dappId, packageOpts.network);
