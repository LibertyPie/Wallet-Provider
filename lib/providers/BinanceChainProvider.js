...
var BinanceChainProvider = /*#__PURE__*/function (_Web3Standard) {
  _inherits(BinanceChainProvider, _Web3Standard);

  var _super = _createSuper(BinanceChainProvider);

  function BinanceChainProvider() {
    _classCallCheck(this, BinanceChainProvider);

    return _super.apply(this, arguments);
  }

  _createClass(BinanceChainProvider, [{
    key: "_initialize",
    value: function () {
...
}(_Web3Standard2["default"]);

var _default = BinanceChainProvider;
