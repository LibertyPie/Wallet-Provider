...
var FrameProvider = /*#__PURE__*/function (_Web3Standard) {
  _inherits(FrameProvider, _Web3Standard);

  var _super = _createSuper(FrameProvider);

  function FrameProvider() {
    _classCallCheck(this, FrameProvider);

    return _super.apply(this, arguments);
  }

  _createClass(FrameProvider, [{
    key: "_initialize",
    value: function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                throw new _Exception["default"]("package_required", "FrameProvider package is required");
