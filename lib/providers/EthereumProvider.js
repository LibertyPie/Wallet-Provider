...
var EthereumProvider = /*#__PURE__*/function (_Web3Standard) {
  _inherits(EthereumProvider, _Web3Standard);
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                provider = win.ethereum || win.web3;
                console.log(provider);

                if (!provider) {
                  this._onConnectCallback(new _Exception["default"]("web3_wallet_not_found", "Web3 Wallet was not found"));
                }
