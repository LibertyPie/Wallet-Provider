...
var AuthereumProvider = /*#__PURE__*/function (_PlatformWallets2) {
  _inherits(AuthereumProvider, _PlatformWallets2);

  var _super = _createSuper(AuthereumProvider);

  function AuthereumProvider() {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                throw new _Exception["default"]("package_required", "Authereum package is required");

              case 3:
                packageOpts = providerInfo.options || {};
                pkgInstance = new providerPackage(packageOpts.network);
