...
var WalletConnectProvider = /*#__PURE__*/function (_PlatformWallets2) {
  _inherits(WalletConnectProvider, _PlatformWallets2);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                throw new _Exception["default"]("wc_package_required", "WalletConnect package is required");

              case 3:
                provider = new providerPackage(providerInfo.options || {}); //provider is same as package
