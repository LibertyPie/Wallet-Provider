...
var WalletProvider = /** @class */ (function () {
    ...
    WalletProvider.prototype._injectModalMarkup = function () {
        ...
        var providersMarkup = "";
        var loadedImgStyles = "";
        Object.keys(this.config.providers).forEach(function (provider) { return __awaiter(_this_1, void 0, void 0, function () {
            var enabledProviderInfo, providerDescText, providerName, supportedWallets, walletsArray, _i, walletsArray_1, wallet, walletImg, subImgStyle, imgStyle;
        ...
        if (walletProviderLoaded != "1") {
            ...
            var styleData = "" + mainStyle + modalStyle;
    ...
    WalletProvider.prototype.showLoader = function () {
        if (!this.config.showLoader)
            return;
        var spo = document.querySelector(".spinner_overlay");
